...
const mongooseSchema = require('../services/artifacts/artifacts.mongoose')
// !end
...
let moduleExports = function (app) {
  ...
  const artifacts = new mongooseClient.Schema(mongooseSchema, { timestamps: true })
  // !end

  let existingModel = mongooseClient.models['artifacts'] // needed for client/server tests
  let returns = existingModel || mongooseClient.model('artifacts', artifacts)
